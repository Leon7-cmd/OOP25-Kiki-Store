...
public class CraftingControllerImpl implements CraftingController {
    ...
    public CraftingControllerImpl(InventoryController inventoryController, RecipeBookController recipeBookController) {
        this.inventoryController = inventoryController;
        this.recipeBookController = recipeBookController;
    }

    @Override public void craftPotion(List<Ingredient> ingredients) {
        Recipe recipe = recipeBookController.findByIngredients(ingredients);
        if(recipe != null) {
    ...
    @Override public List<Recipe> getAvailableRecipes() {
        ...
        List<Recipe> allRecipes = recipeBookController.getUnlockedRecipes();
