 ...
 */
public class CraftingTestState implements GameState {
    ...
    public void update() {
        if (!initialized) {
            ...
            final CraftingController craftingController =
                new CraftingControllerImpl(inventoryController, recipeBookController);
            ...
            inventoryController.addIngredient(
                "Dandelion", "sprites/ingredients/dandelion", 3, "plant");
            inventoryController.addIngredient(
                "Chamomile", "sprites/ingredients/chamomile", 3, "plant");
            inventoryController.addIngredient(
