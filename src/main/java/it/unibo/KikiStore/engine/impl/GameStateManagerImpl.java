 ...
 * It acts as the intermediary component between the GameEngine and individual
 * states (e.g., Menu, Gameplay, Pause).
 * Ensures that exactly one active state handles the update and rendering logic
 * at any given time.
 */
public class GameStateManagerImpl implements GameStateManager {
     ...
     * Automatically manages the lifecycle of the new state by calling its init()
     * method.
     * 
